...
#include "VehicleSportsCar.h"
#include "VehicleSportsWheelFront.h"
#include "VehicleSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AVehicleSportsCar::AVehicleSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVehicleSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVehicleSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVehicleSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVehicleSportsWheelRear::StaticClass();
